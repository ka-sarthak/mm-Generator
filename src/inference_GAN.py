...
from utilities import ImportDataset, MAE, NMAE, MinMaxScaling, GaussianScaling, LossPlotsGAN
...
path_save_model   = os.path.join(main_path, f"saved_models/GAN/UNet/{exp_name}/generator.pt")
path_save 		= os.path.join(main_path,f"testing/GAN/UNet/{exp_name}/")
...
LossPlotsGAN(gen_train_loss,gen_val_loss,None,path_plots,exp_name)
